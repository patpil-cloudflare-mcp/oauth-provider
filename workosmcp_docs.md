...
```bash
curl https://cool-grape-21-staging.authkit.app/.well-known/oauth-authorization-server | jq
{
  "authorization_endpoint": "https://cool-grape-21-staging.authkit.app/oauth2/authorize",
  "code_challenge_methods_supported": ["S256"],
  "grant_types_supported": ["authorization_code", "refresh_token"],
  "introspection_endpoint": "https://cool-grape-21-staging.authkit.app/oauth2/introspection",
  "issuer": "https://cool-grape-21-staging.authkit.app",
  "registration_endpoint": "https://cool-grape-21-staging.authkit.app/oauth2/register",
  "scopes_supported": ["email", "offline_access", "openid", "profile"],
  "response_modes_supported": ["query"],
  "response_types_supported": ["code"],
  "token_endpoint": "https://cool-grape-21-staging.authkit.app/oauth2/token",
...
const JWKS = createRemoteJWKSet(new URL('https://cool-grape-21-staging.authkit.app/oauth2/jwks'));
...
app.get('/.well-known/oauth-protected-resource', (req, res) =>
  res.json({
    ...
    authorization_servers: ['https://cool-grape-21-staging.authkit.app'],
...
app.get('/.well-known/oauth-authorization-server', async (req, res) => {
  const response = await fetch(
    'https://cool-grape-21-staging.authkit.app/.well-known/oauth-authorization-server',
  );
